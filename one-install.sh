...
echo "Installing cent tool...."
go install -v github.com/xm1k3/cent@latest

echo "Installing subjack tool...."
go install github.com/haccer/subjack@latest

echo "Installing qsfuzz tool...."
...
echo "Installing EyeWitness tool...."
https://github.com/FortyNorthSecurity/EyeWitness.git ~/Desktop/tools/EyeWitness
bash ~/Desktop/tools/EyeWitness/Python/setup/setup.sh
